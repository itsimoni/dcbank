              ...
              {cards.map((card) => (
                <div key={card.id} className="flex flex-col">
                  <div className="bg-white border-l-8 border-l-[#b91c1c] p-5 shadow-lg pointer-events-none relative">
                    ...
                    <div className="mb-5">
                      <p className="text-base font-mono tracking-wider break-all text-gray-900">
                        {formatCardNumber(
                          card.card_number,
                  ...
                  <Card className="flex-1 bg-white border-l-4 border-l-[#b91c1c] border-y-0 border-r-0 rounded-none mt-0">
                    <CardContent className="p-4">
                      ...
                      {card.status === "Pending" && (
                        <div className="border-l-4 border-l-yellow-600 bg-yellow-50 p-2 mb-3">
                      ...
                      {card.status === "Approved" && (
                        <div className="border-l-4 border-l-blue-600 bg-blue-50 p-2 mb-3">
                          <div className="flex items-start">
                      ...
                      {card.status === "Frozen" && (
                        <div className="border-l-4 border-l-red-600 bg-red-50 p-2 mb-3">
                          <div className="flex items-start">
