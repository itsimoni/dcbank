  ...
  const submitTransfer = async () => {
    ...
    try {
      ...
      if (totalAmount > currentBalance) {
        alert(`${t.insufficientBalanceFor} ${formData.crypto_type} ${t.balanceForTransfer}`);
        return;
      }
                ...
                <div className="animate-in slide-in-from-right duration-300 pointer-events-auto">
                  <Alert className="border-green-200 bg-green-50 shadow-lg">
                    ...
                    <AlertDescription className="text-green-800">
                      <strong>{t.transferRequestSubmitted}</strong>
                      <br />
                      {t.cryptoTransferReceived}
                    </AlertDescription>
                  </Alert>
                </div>
              )}
                        ...
                        <SelectItem key={network.value} value={network.value}>
                          <div className="flex items-center justify-between w-full">
                            ...
                            <span className="text-gray-500 text-sm ml-4">
                              {t.feePrefix}{network.fee} {selectedCrypto.value}
                            </span>
                          </div>
                        </SelectItem>
                      ))}
              ...
              {amount > 0 && gasFee > 0 && selectedCrypto && (
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-4 border">
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedNetwork && (
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">{t.networkColon}</span>
                        <span className="font-medium">
              ...
              {totalAmount > currentBalance && totalAmount > 0 && (
                <Alert className="border-red-200 bg-red-50">
                  ...
                  <AlertDescription className="text-red-800">
                    ...
                    {formData.crypto_type} {t.butOnlyHave}{" "}
                    {formatCryptoAmount(
                      currentBalance,
                      selectedCrypto?.decimals || 8
                    )}{" "}
                    {formData.crypto_type} {t.availableSuffix}
                  </AlertDescription>
                </Alert>
              )}
                    ...
                    >
                      <div className="flex-1 space-y-1">
                        ...
                        <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                          <span>{t.networkColon} {transaction.network}</span>
                          <span>
