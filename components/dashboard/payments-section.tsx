...
export default function PaymentsSection({ userProfile }: PaymentsSectionProps) {
  ...
  const [showCryptoTermsDialog, setShowCryptoTermsDialog] = useState(false);
  ...
  return (
    <div className="h-full overflow-y-auto bg-gray-50">
      ...
      <Dialog open={showCryptoTermsDialog} onOpenChange={setShowCryptoTermsDialog}>
        <DialogContent className="max-w-4xl max-h-[90vh]">
          ...
          <ScrollArea className="h-[70vh] pr-4">
            <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
              <div className="bg-gray-50 p-4 border-l-4 border-[#b91c1c]">
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">1. DEFINITIONS AND INTERPRETATION</h3>
                <p className="mb-2">1.1. "Cryptocurrency" or "Digital Asset" refers to any blockchain-based digital currency, including but not limited to Bitcoin (BTC), Ethereum (ETH), Tether (USDT), and any other virtual currencies supported by our platform.</p>
                <p className="mb-2">1.2. "Transaction" means any transfer, exchange, deposit, withdrawal, or conversion of cryptocurrency conducted through our services.</p>
                <p className="mb-2">1.3. "Wallet Address" refers to a unique alphanumeric identifier used to send and receive cryptocurrency on a blockchain network.</p>
                <p className="mb-2">1.4. "Blockchain" means a distributed ledger technology that records transactions across multiple computers in a manner that cannot be altered retroactively.</p>
                <p className="mb-2">1.5. "Smart Contract" refers to self-executing code deployed on a blockchain network that automatically enforces the terms of an agreement.</p>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">2. ELIGIBILITY AND USER REPRESENTATIONS</h3>
                <p className="mb-2">2.1. By using our cryptocurrency payment services, you represent and warrant that:</p>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">3. NATURE OF CRYPTOCURRENCY TRANSACTIONS</h3>
                <p className="mb-2">3.1. <strong>Irreversibility:</strong> You expressly acknowledge and understand that cryptocurrency transactions are irreversible once confirmed on the blockchain. Unlike traditional banking systems, there is no central authority capable of reversing, canceling, or modifying a completed transaction. Once you initiate a cryptocurrency transfer, the transaction cannot be undone, and the Company bears no responsibility for any errors in wallet addresses, amounts, or network selection.</p>
                <p className="mb-2">3.2. <strong>Finality:</strong> All cryptocurrency transactions are final upon blockchain confirmation. The Company cannot recover funds sent to incorrect addresses, unsupported networks, or lost due to user error.</p>
                <p className="mb-2">3.3. <strong>Network Fees:</strong> Cryptocurrency transactions require network fees (commonly known as "gas fees" for Ethereum-based transactions or "miner fees" for Bitcoin). These fees are paid to blockchain network validators and are non-refundable, regardless of transaction outcome.</p>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">4. RISK DISCLOSURE AND ACKNOWLEDGMENT</h3>
                <p className="mb-2">4.1. <strong>Market Volatility:</strong> Cryptocurrency markets are highly volatile. The value of digital assets can fluctuate significantly within short periods. You acknowledge that you may experience substantial losses and that past performance is not indicative of future results.</p>
                <p className="mb-2">4.2. <strong>Regulatory Risk:</strong> The regulatory status of cryptocurrencies varies by jurisdiction and is subject to change. New laws or regulations may adversely affect the use, transfer, or value of cryptocurrencies. You are solely responsible for compliance with applicable laws in your jurisdiction.</p>
                <p className="mb-2">4.3. <strong>Technology Risk:</strong> Blockchain technology is subject to technological risks including, but not limited to, software bugs, network attacks, protocol changes, hard forks, and potential obsolescence. The Company does not guarantee the continuous operation or security of any blockchain network.</p>
                <p className="mb-2">4.4. <strong>Security Risk:</strong> Despite implementing industry-standard security measures, no system is completely secure. You acknowledge the risk of unauthorized access, hacking, theft, and loss of digital assets.</p>
                <p className="mb-2">4.5. <strong>Counterparty Risk:</strong> Transactions with third parties carry inherent risks. The Company is not responsible for the actions, omissions, or failures of any third party.</p>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">5. USER RESPONSIBILITIES</h3>
                <p className="mb-2">5.1. <strong>Accuracy of Information:</strong> You are solely responsible for ensuring the accuracy of all information provided, including but not limited to wallet addresses, transaction amounts, and network selection. The Company shall not be liable for any losses resulting from incorrect information.</p>
                <p className="mb-2">5.2. <strong>Security:</strong> You are responsible for maintaining the security of your account credentials, private keys, and any devices used to access our services. You agree to immediately notify the Company of any unauthorized access or security breaches.</p>
                <p className="mb-2">5.3. <strong>Compliance:</strong> You agree to comply with all applicable laws, regulations, and these Terms and Conditions when using our services.</p>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">6. ANTI-MONEY LAUNDERING (AML) AND KNOW YOUR CUSTOMER (KYC)</h3>
                <p className="mb-2">6.1. The Company is committed to preventing money laundering, terrorist financing, and other financial crimes. By using our services, you agree to comply with our AML and KYC policies.</p>
                <p className="mb-2">6.2. You may be required to provide identity verification documents, proof of address, source of funds documentation, and other information as requested by the Company.</p>
                <p className="mb-2">6.3. The Company reserves the right to refuse, suspend, or terminate services to any user who fails to meet our KYC requirements or whose activities raise suspicion of illegal conduct.</p>
              ...
              <section>
                ...
                <p className="mb-2">7.1. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE COMPANY SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, REGARDLESS OF WHETHER SUCH DAMAGES WERE FORESEEABLE OR WHETHER THE COMPANY WAS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
                <p className="mb-2">7.2. The Company's total liability for any claims arising out of or related to these Terms shall not exceed the lesser of: (a) the amount of fees paid by you to the Company in the twelve (12) months preceding the claim, or (b) one hundred euros (EUR 100).</p>
                <p className="mb-2">7.3. The Company shall not be liable for any losses arising from:</p>
                <ul className="list-disc pl-6 space-y-1 mb-3">
              ...
              <section>
                ...
                <p className="mb-2">9.1. All intellectual property rights in our services, including but not limited to software, trademarks, logos, and content, are owned by or licensed to the Company.</p>
              ...
              <section>
                ...
                <p className="mb-2">10.1. The collection, use, and protection of your personal information is governed by our Privacy Policy, which is incorporated into these Terms by reference.</p>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">11. MODIFICATIONS TO TERMS</h3>
                <p className="mb-2">11.1. The Company reserves the right to modify these Terms at any time. Material changes will be communicated through our platform or via email.</p>
                <p>11.2. Your continued use of our services after any modifications constitutes acceptance of the updated Terms.</p>
              </section>

              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">12. TERMINATION</h3>
                <p className="mb-2">12.1. The Company may suspend or terminate your access to our services at any time, with or without cause, and with or without notice.</p>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">13. DISPUTE RESOLUTION</h3>
                <p className="mb-2">13.1. Any disputes arising out of or relating to these Terms shall first be attempted to be resolved through good-faith negotiation between the parties.</p>
                <p className="mb-2">13.2. If negotiation fails, disputes shall be resolved through binding arbitration in accordance with the rules of the relevant arbitration institution in the Company's jurisdiction.</p>
              ...
              <section>
                ...
                <p className="mb-2">14.1. These Terms shall be governed by and construed in accordance with the laws of the European Union and the jurisdiction in which the Company is registered, without regard to conflict of law principles.</p>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">15. SEVERABILITY</h3>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">16. ENTIRE AGREEMENT</h3>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">17. WAIVER</h3>
              ...
              <section>
                <h3 className="text-lg font-bold text-gray-900 mb-3">18. CONTACT INFORMATION</h3>
              ...
              <div className="bg-gray-50 p-4 border border-gray-200 mt-6">
                <p className="font-semibold text-gray-900 mb-2">ACKNOWLEDGMENT OF TERMS</p>
          ...
          <div className="flex justify-end pt-4 border-t">
            <Button
              onClick={() => setShowCryptoTermsDialog(false)}
